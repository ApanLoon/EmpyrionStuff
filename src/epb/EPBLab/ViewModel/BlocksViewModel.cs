...
namespace EPBLab.ViewModel
{
    public class BlocksViewModel : ViewModelBase
    {
        ...
        private GeometryModel3D CreateBuildingBlockFull(Point3D pos, EpbBlock block, EpBlueprint blueprint)
        {
            ...
            switch (block.Variant)
            {
                ...
                case 14: //RoundCornerLong
                    faceIndex = AddGeometry_RoundCornerLong(vertices, triangles, normals, faceIndex);
                    break;
                case 15: //RoundSlope
                ...
                */
                ...
                case 22: //CylinderEndB
                    faceIndex = AddGeometry_CylinderEndB(vertices, triangles, normals, faceIndex);
                    break;
                case 23: //CylinderEndC
                    faceIndex = AddGeometry_CylinderEndC(vertices, triangles, normals, faceIndex);
                    break;
                /*
        ...
        {
            // Topface
            vertices.Add(new Point3D(0.499521, -0.500000, -0.500479));
            vertices.Add(new Point3D(0.240702, -0.500000, -0.466405));
            vertices.Add(new Point3D(-0.000479, -0.500000, -0.366505));
            vertices.Add(new Point3D(-0.207586, -0.500000, -0.207586));
            vertices.Add(new Point3D(-0.366505, -0.500000, -0.000479));
            vertices.Add(new Point3D(-0.466405, -0.500000, 0.240702));
            vertices.Add(new Point3D(-0.500479, -0.500000, 0.499521));
            vertices.Add(new Point3D(0.499521, -0.241181, -0.466405));
            vertices.Add(new Point3D(0.249521, -0.241181, -0.433492));
            vertices.Add(new Point3D(0.016558, -0.241181, -0.336996));
            vertices.Add(new Point3D(-0.183492, -0.241181, -0.183492));
            vertices.Add(new Point3D(-0.336996, -0.241181, 0.016558));
            vertices.Add(new Point3D(-0.433492, -0.241181, 0.249521));
            vertices.Add(new Point3D(-0.466405, -0.241181, 0.499521));
            vertices.Add(new Point3D(0.499521, -0.000000, -0.366505));
            vertices.Add(new Point3D(0.275377, -0.000000, -0.336996));
            vertices.Add(new Point3D(0.066508, -0.000000, -0.250479));
            vertices.Add(new Point3D(-0.112852, -0.000000, -0.112852));
            vertices.Add(new Point3D(-0.250479, -0.000000, 0.066508));
            vertices.Add(new Point3D(-0.336996, -0.000000, 0.275377));
            vertices.Add(new Point3D(-0.366505, -0.000000, 0.499521));
            vertices.Add(new Point3D(0.499521, 0.207107, -0.207586));
            vertices.Add(new Point3D(0.316508, 0.207107, -0.183492));
            vertices.Add(new Point3D(0.145967, 0.207107, -0.112852));
            vertices.Add(new Point3D(-0.000479, 0.207107, -0.000479));
            vertices.Add(new Point3D(-0.112852, 0.207107, 0.145967));
            vertices.Add(new Point3D(-0.183492, 0.207107, 0.316508));
            vertices.Add(new Point3D(-0.207586, 0.207107, 0.499521));
            vertices.Add(new Point3D(0.499521, 0.366025, -0.000479));
            vertices.Add(new Point3D(0.370111, 0.366025, 0.016558));
            vertices.Add(new Point3D(0.249521, 0.366025, 0.066508));
            vertices.Add(new Point3D(0.145967, 0.366025, 0.145967));
            vertices.Add(new Point3D(0.066508, 0.366025, 0.249521));
            vertices.Add(new Point3D(0.016558, 0.366025, 0.370111));
            vertices.Add(new Point3D(-0.000479, 0.366025, 0.499521));
            vertices.Add(new Point3D(0.499521, 0.465926, 0.240702));
            vertices.Add(new Point3D(0.432533, 0.465926, 0.249521));
            vertices.Add(new Point3D(0.370111, 0.465926, 0.275377));
            vertices.Add(new Point3D(0.316508, 0.465926, 0.316508));
            vertices.Add(new Point3D(0.275377, 0.465926, 0.370111));
            vertices.Add(new Point3D(0.249521, 0.465926, 0.432533));
            vertices.Add(new Point3D(0.240702, 0.465926, 0.499521));
            vertices.Add(new Point3D(0.499521, 0.500000, 0.499521));
            ...
            normals.Add(new Vector3D(-0.127487, 0.214520, -0.968364));
            ...
            normals.Add(new Vector3D(-0.946203, 0.298635, -0.124570));
            normals.Add(new Vector3D(-0.115996, 0.458534, -0.881074));
            ...
            normals.Add(new Vector3D(-0.838063, 0.534300, -0.110333));
            normals.Add(new Vector3D(-0.096618, 0.672361, -0.733890));
            ...
            normals.Add(new Vector3D(-0.672677, 0.734618, -0.088560));
            normals.Add(new Vector3D(-0.070573, 0.841230, -0.536052));
            ...
            normals.Add(new Vector3D(-0.460602, 0.885533, -0.060639));
            normals.Add(new Vector3D(-0.039577, 0.952922, -0.300620));
            ...
            normals.Add(new Vector3D(-0.258598, 0.965385, -0.034045));
        ...
        private int AddGeometry_RoundCornerLong(Point3DCollection vertices, Int32Collection triangles, Vector3DCollection normals, int faceIndex)
        {
            // Frontface
            vertices.Add(new Point3D(0.499521, -0.500000, 0.499521));
            vertices.Add(new Point3D(0.499521, -0.500000, -0.500479));
            ...
            vertices.Add(new Point3D(-0.000479, 0.366025, 0.499521));
            vertices.Add(new Point3D(0.240702, 0.465926, 0.499521));
            vertices.Add(new Point3D(-0.500479, -0.499984, -0.500504));
            vertices.Add(new Point3D(-0.500479, -0.500000, 0.499521));
            vertices.Add(new Point3D(-0.466405, -0.241181, -0.465631));
            vertices.Add(new Point3D(-0.366505, 0.000000, -0.365730));
            vertices.Add(new Point3D(-0.207586, 0.207107, -0.206812));
            vertices.Add(new Point3D(-0.000479, 0.366025, 0.000295));
            vertices.Add(new Point3D(0.240702, 0.465926, 0.241476));
            vertices.Add(new Point3D(0.498746, 0.499898, 0.499521));
            normals.Add(new Vector3D(-0.953650, 0.300918, -0.000000));
            normals.Add(new Vector3D(-0.843272, 0.537487, -0.000000));
            normals.Add(new Vector3D(-0.675426, 0.737428, -0.000000));
            normals.Add(new Vector3D(-0.461551, 0.887114, -0.000000));
            normals.Add(new Vector3D(-0.258819, 0.965926, 0.000000));
            normals.Add(new Vector3D(-0.991444, 0.130534, 0.000002));
            normals.Add(new Vector3D(-0.991444, 0.130530, 0.000001));
            normals.Add(new Vector3D(-0.976344, 0.216225, 0.000001));
            normals.Add(new Vector3D(-0.887114, 0.461551, -0.000000));
            normals.Add(new Vector3D(-0.737428, 0.675426, -0.000000));
            normals.Add(new Vector3D(-0.537487, 0.843272, -0.000000));
            normals.Add(new Vector3D(-0.300918, 0.953650, 0.000000));
            normals.Add(new Vector3D(-0.130526, 0.991445, 0.000000));
            AddTriangle(triangles, faceIndex + 11, faceIndex + 4, faceIndex + 12);
            AddTriangle(triangles, faceIndex + 0, faceIndex + 7, faceIndex + 6);
            AddTriangle(triangles, faceIndex + 5, faceIndex + 6, faceIndex + 7);
            AddTriangle(triangles, faceIndex + 1, faceIndex + 8, faceIndex + 0);
            AddTriangle(triangles, faceIndex + 7, faceIndex + 0, faceIndex + 8);
            AddTriangle(triangles, faceIndex + 2, faceIndex + 9, faceIndex + 1);
            AddTriangle(triangles, faceIndex + 8, faceIndex + 1, faceIndex + 9);
            AddTriangle(triangles, faceIndex + 3, faceIndex + 10, faceIndex + 2);
            AddTriangle(triangles, faceIndex + 9, faceIndex + 2, faceIndex + 10);
            AddTriangle(triangles, faceIndex + 4, faceIndex + 11, faceIndex + 3);
            AddTriangle(triangles, faceIndex + 10, faceIndex + 3, faceIndex + 11);
            faceIndex += 13;
            // TopfaceLeft
            vertices.Add(new Point3D(0.499456, 0.466257, 0.243283));
            vertices.Add(new Point3D(0.499456, 0.366357, 0.002102));
            vertices.Add(new Point3D(0.499456, 0.207438, -0.205005));
            vertices.Add(new Point3D(0.499456, 0.000331, -0.363923));
            vertices.Add(new Point3D(0.499456, -0.240850, -0.463824));
            vertices.Add(new Point3D(0.499456, -0.499890, -0.500651));
            vertices.Add(new Point3D(-0.500479, -0.499999, -0.500651));
            vertices.Add(new Point3D(0.240702, 0.466257, 0.243283));
            vertices.Add(new Point3D(0.499456, 0.499992, 0.499521));
            vertices.Add(new Point3D(-0.000479, 0.366357, 0.002102));
            vertices.Add(new Point3D(-0.207586, 0.207438, -0.205005));
            vertices.Add(new Point3D(-0.366505, 0.000331, -0.363923));
            vertices.Add(new Point3D(-0.466405, -0.240850, -0.463824));
            normals.Add(new Vector3D(0.000000, 0.953650, -0.300918));
            normals.Add(new Vector3D(0.000000, 0.843272, -0.537487));
            normals.Add(new Vector3D(0.000000, 0.675426, -0.737428));
            normals.Add(new Vector3D(0.000000, 0.461551, -0.887114));
            normals.Add(new Vector3D(-0.000005, 0.222942, -0.974832));
            normals.Add(new Vector3D(-0.000015, 0.140754, -0.990045));
            normals.Add(new Vector3D(-0.000008, 0.140725, -0.990049));
            normals.Add(new Vector3D(0.000000, 0.965926, -0.258819));
            normals.Add(new Vector3D(0.000000, 0.991445, -0.130526));
            normals.Add(new Vector3D(0.000000, 0.887114, -0.461551));
            normals.Add(new Vector3D(0.000000, 0.737428, -0.675426));
            normals.Add(new Vector3D(0.000000, 0.537487, -0.843272));
            normals.Add(new Vector3D(0.000000, 0.304155, -0.952622));
            AddTriangle(triangles, faceIndex + 1, faceIndex + 9, faceIndex + 0);
            AddTriangle(triangles, faceIndex + 7, faceIndex + 0, faceIndex + 9);
            AddTriangle(triangles, faceIndex + 2, faceIndex + 10, faceIndex + 1);
            AddTriangle(triangles, faceIndex + 9, faceIndex + 1, faceIndex + 10);
            AddTriangle(triangles, faceIndex + 3, faceIndex + 11, faceIndex + 2);
            AddTriangle(triangles, faceIndex + 10, faceIndex + 2, faceIndex + 11);
            AddTriangle(triangles, faceIndex + 4, faceIndex + 12, faceIndex + 3);
            AddTriangle(triangles, faceIndex + 11, faceIndex + 3, faceIndex + 12);
            AddTriangle(triangles, faceIndex + 5, faceIndex + 6, faceIndex + 4);
            AddTriangle(triangles, faceIndex + 12, faceIndex + 4, faceIndex + 6);
            AddTriangle(triangles, faceIndex + 8, faceIndex + 0, faceIndex + 7);
            faceIndex += 13;
            // Bottomface
            vertices.Add(new Point3D(0.499521, -0.500000, 0.499521));
            vertices.Add(new Point3D(-0.500479, -0.500000, -0.500479));
            vertices.Add(new Point3D(0.499521, -0.500000, -0.500479));
            vertices.Add(new Point3D(-0.500479, -0.500000, 0.499521));
            normals.Add(new Vector3D(0.000000, -1.000000, -0.000000));
            normals.Add(new Vector3D(0.000000, -1.000000, -0.000000));
