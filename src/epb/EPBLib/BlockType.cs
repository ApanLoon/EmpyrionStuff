...
namespace EPBLib
{
    public class BlockType
    {
        ...
        public static readonly Dictionary<UInt16, BlockType> BlockTypes = new Dictionary<UInt16, BlockType>()
        {
            ...
            {    57, new BlockType(){Id =    57, Name = "VoxelRock"                    , Category = "Voxel/Materials"              , Ref = ""                             }},
            {    79, new BlockType(){Id =    79, Name = "VoxelCopper"                  , Category = "Voxel/Materials"              , Ref = ""                             }},
            {    80, new BlockType(){Id =    80, Name = "VoxelPromethium"              , Category = "Voxel/Materials"              , Ref = ""                             }},
            {    81, new BlockType(){Id =    81, Name = "VoxelIron"                    , Category = "Voxel/Materials"              , Ref = ""                             }},
            {    82, new BlockType(){Id =    82, Name = "VoxelSilicon"                 , Category = "Voxel/Materials"              , Ref = ""                             }},
            {    83, new BlockType(){Id =    83, Name = "VoxelNeodymium"               , Category = "Voxel/Materials"              , Ref = ""                             }},
            {    84, new BlockType(){Id =    84, Name = "VoxelMagnesium"               , Category = "Voxel/Materials"              , Ref = ""                             }},
            {    85, new BlockType(){Id =    85, Name = "VoxelCobalt"                  , Category = "Voxel/Materials"              , Ref = ""                             }},
            {    90, new BlockType(){Id =    90, Name = "VoxelErestrum"                , Category = "Voxel/Materials"              , Ref = ""                             }},
            {    91, new BlockType(){Id =    91, Name = "VoxelZascosium"               , Category = "Voxel/Materials"              , Ref = ""                             }},
            {    95, new BlockType(){Id =    95, Name = "VoxelGold"                    , Category = "Voxel/Materials"              , Ref = ""                             }},
            {   114, new BlockType(){Id =   114, Name = "VoxelPentaxid"                , Category = "Voxel/Materials"              , Ref = ""                             }},
