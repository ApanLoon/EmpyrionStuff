...
namespace EPBLib
{
    public class EpbBlock
    {
        ...
        public static readonly Dictionary<UInt16, EpbBlockType> BlockTypes = new Dictionary<UInt16, EpbBlockType>()
        {
            ...
            {  1889, new EpbBlockType(){Id =  1889, Name = "HangarDoor10x7x1"             , Category = "Devices"                      , Ref = "HangarDoor01Medium"           }},
            {  1890, new EpbBlockType(){Id =  1890, Name = "HangarDoor5x1x1"              , Category = "Devices"                      , Ref = "HangarDoor01Medium"           }},
            {  1900, new EpbBlockType(){Id =  1900, Name = "ShutterDoor3x1"               , Category = "Devices"                      , Ref = "ShutterDoor1x1"               }},
            {  1901, new EpbBlockType(){Id =  1901, Name = "ShutterDoor4x1"               , Category = "Devices"                      , Ref = "ShutterDoor1x1"               }},
